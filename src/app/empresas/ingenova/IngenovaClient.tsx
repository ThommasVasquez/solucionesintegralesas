...
const HERO_SLIDES = [
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/floculador-test-de-jarras-et730_mb2_01-1.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/evobasic-35ghr-35-ghr-piscina-privada.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/suavizador-de-agua-en-gabinete-PURIKOR-bogota.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/fresh-JSW-1-transformed.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2024/10/sumergible.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2024/05/instalacion-de-equipos-1-modified.webp",
...
const SOLUTIONS = [
  {
    image: "https://aquaintegral.co/wp-content/uploads/2022/12/Descargar-archivos-aqua-integral.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2022/12/disena-tu-Planta-de-tratamiento-agua-potable-aqua-integral.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2022/12/Equipos-para-piscina-disena-tu-cuarto-de-maquinas-piscina-jacuzzi.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/Aprende-con-nosotros-Aqua-Integral.webp",
...
const BEST_SELLERS = [
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/pixelcut-export-1-300x300.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/purikor-pk-uv-6-1-1-1-300x300.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/Disco-difusor-para-treatment-de-aire-300x300.webp",
  ...
  {
    image: "https://aquaintegral.co/wp-content/uploads/2025/01/K-2005s-Taylor-completo-removebg-preview-1-300x300.webp",
      ...
      <header className={`${s.header} ${isScrolled ? s.scrolled : ""}`}>
        <div className={s.navContainer}>
          <a href="#inicio" className={s.logoLink}>
            <Image
              src="https://aquaintegral.co/wp-content/uploads/2023/08/LOGO-PNG.webp"
              alt="Aqua Integral Logo"
              width={160}
              height={65}
              className={s.logoImg}
              priority
